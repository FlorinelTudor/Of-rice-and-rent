...
- Replaced the final-results reveal slide with an award-free family ledger scene, changed the reveal copy to "The ledgers are opened," suppressed stale hiring pop-ups when a job-loss shock fires, and added per-player score breakdowns on the leaderboard.
- Renamed "A Recovery Stumbles" to "Recovery Stumbles," restored the final reveal tension question, prevented selecting/submitting two work actions in the same phase, and softened predictable-play penalties with later triggers, smaller increments, and an 8-point cap.
